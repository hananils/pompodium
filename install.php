...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	function getDynamicConfiguration(){
		...
		$conf['symphony']['version'] = '2.0.8RC2';
		...
		$conf['general']['sitename'] = 'Pompodium';
		$conf['region']['time_format'] = 'H:i';
		$conf['region']['date_format'] = 'd F Y';
		$conf['maintenance_mode']['enabled'] = 'yes';
		$conf['canofspam']['uniqueid'] = '321cac56396d50209bb1c95268e222bf';
		$conf['typography']['rules'] = 'english';
		$conf['documentation']['text-formatter'] = 'none';
		$conf['documentation']['button-text'] = 'Hilfe';
