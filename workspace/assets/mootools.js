...
//HistoryManager, <http://www.nmjenkins.com/photos/js/HistoryManager.js>. Author Neil Jenkins <http://www.nmjenkins.com>, Version 2.0 (2008-08-23), GNU GPL 2.0 Licence <http://creativecommons.org/licenses/GPL/2.0>

var HistoryManager=(function(){var A=new Class({Implements:Events,initialize:function(){this._currentLocation=this._getHash();if(Browser.Engine.trident&&Browser.Engine.version<=5){this._iframe=new IFrame({src:"javascript:'<html><body>"+this._currentLocation.replace(/(['"])/g,"\\$1")+"</body></html>'",styles:{display:"none"}}).inject(document.body).contentWindow;this.addState=this._addStateIE;this._monitorIE.periodical(200,this);}else{if(Browser.Engine.webkit419){this._form=new Element("form",{method:"get"}).inject(document.body);this._historyCounter=history.length;this._stateHistory=[];this._stateHistory[history.length]=this._getHash();this.addState=this._addStateSafari;this._monitorSafari.periodical(200,this);}else{if(Browser.Engine.presto925){this.addState=this._addStateDefault;window.$justForOpera=this._monitorDefault.bind(this);new Element("img",{src:"javascript:location.href='javascript:$justForOpera();';",style:"position: absolute; top: -1000px;"}).inject(document.body);}else{this.addState=this._addStateDefault;this._monitorDefault.periodical(200,this);}}}},getCurrentHash:function(){return this._currentLocation;},_getHash:function(){return top.location.href.indexOf("#")>-1?top.location.href.split("#")[1].slice(1):"";},_addStateIE:function(C){if(this._currentLocation!=C){this._currentLocation=C;top.location.hash="#/"+C;this._iframe.document.open("text/html");this._iframe.document.write("<html><body>",C,"</body></html>");this._iframe.document.close();}return this;},_monitorIE:function(){var C=this._iframe.document.body.innerText;if(C!=this._currentLocation){top.location.hash="#/"+C;this._currentLocation=C;this.fireEvent("onHistoryChange",[C]);}},_addStateSafari:function(C){if(this._currentLocation!=C){this._form.set("action","#/"+C).submit();this._currentLocation=C;this._stateHistory[history.length]=this._getHash();this._historyCounter=history.length;}return this;},_monitorSafari:function(){if(history.length!=this._historyCounter){this._historyCounter=history.length;this._currentLocation=this._stateHistory[history.length];this.fireEvent("onHistoryChange",[this._currentLocation]);}},_addStateDefault:function(C){if(this._currentLocation!=C){top.location.hash="#/"+C;this._currentLocation=C;}return this;},_monitorDefault:function(){var C=this._getHash();if(C!=this._currentLocation){this._currentLocation=C;this.fireEvent("onHistoryChange",[C]);}}});var B;return function(){return B||(B=new A());};})();